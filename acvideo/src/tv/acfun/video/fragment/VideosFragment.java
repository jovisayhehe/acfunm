...
public class VideosFragment extends RefreshActionGridFragment {
    ...
    private static final int COLOR_WATCHED = 0xFF999999;
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        try {
            ...
            if (tag != null && tag instanceof ViewHolder) {
                ...
                holder.titleView.setTextColor(COLOR_WATCHED);
            }
    ...
    private class VideosAdapter extends BaseArrayAdapter<Video> {
        ...
        private void handleImageRequest(ViewHolder holder, Video item) {
            ...
            holder.imageContainer = AcApp.getGloableLoader().get(item.previewurl, imageListener);
        }
        ...
        private void setItemText(ViewHolder holder, Video item) {
            ...
            holder.titleView.setTextColor(mDb.isWatched(item.acId) ? COLOR_WATCHED : COLOR_BLACK);
