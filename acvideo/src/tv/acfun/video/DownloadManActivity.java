...
import tv.ac.fun.R;
import tv.acfun.video.DownloadService.IDownloadService;
import tv.acfun.video.adapter.DownloadJobAdapter;
import tv.acfun.video.adapter.DownloadJobAdapter.OnItemCheckedListener;
...
import tv.acfun.video.util.download.DownloadManager.DownloadObserver;
...
public class DownloadManActivity extends ActionBarActivity implements OnNavigationListener, DownloadObserver {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(mBar.getThemedContext(), R.array.download_state,
    ...
    protected void startToPlay(DownloadEntry entry) {
        PlayerActivity.start(this, entry.part);
    }
}
