...
import tv.danmaku.media.AbsMediaPlayer.OnVideoSizeChangedListener;
...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
  ...
  private DefMediaListPlayer mMediaPlayer = null;
  ...
  private DefMediaListPlayer.OnCompletionListener mOnCompletionListener;
  private DefMediaListPlayer.OnPreparedListener mOnPreparedListener;
  private DefMediaListPlayer.OnErrorListener mOnErrorListener;
  private DefMediaListPlayer.OnSeekCompleteListener mOnSeekCompleteListener;
  private DefMediaListPlayer.OnInfoListener mOnInfoListener;
  private DefMediaListPlayer.OnBufferingUpdateListener mOnBufferingUpdateListener;
  ...
  private OnErrorListener mErrorListener = new OnErrorListener() {
    public boolean onError(AbsMediaPlayer mp, int framework_err, int impl_err) {
  ...
  private void openVideo() {
    if (mPart == null || mSurfaceHolder == null || !Vitamio.isInitialized(mContext))
      return;
    ...
    try {
      ...
      mMediaPlayer = new DefMediaListPlayer(mContext,mPart);
...
//      mMediaPlayer.setDataSource(mContext, mUri);
      ...
      Log.e("Unable to open content: " + mPart, ex);
      mCurrentState = STATE_ERROR;
      mTargetState = STATE_ERROR;
  ...
  private void attachMediaController() {
    if (mMediaPlayer != null && mMediaController != null) {
      ...
      if (mPart != null) {
        mMediaController.setFileName(mPart.subtitle);
      }
    }
  }
