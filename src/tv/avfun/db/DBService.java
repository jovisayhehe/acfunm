...
public class DBService {
	...
	public void saveUser(HashMap<String, Object> map){
		...
		db.execSQL("INSERT INTO USER (USERID,USERNAME,AVATAR,SIGNATURE,COOKIES)" +
				"VALUES(?,?,?,?,?)", new Object[]{String.valueOf(map.get("uid")),(String)map.get("uname")
				 ,(String)map.get("avatar"),(String)map.get("signature"),
				 jsonarray.toString()});
		db.close();
	}
