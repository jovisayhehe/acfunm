...
//        findPreference("about").setSummary("v"+app.getVersionName());
        ...
        dialog = new AlertDialog.Builder(HelpActivity.this)
            .setView(mFaqView)
            .setCancelable(true)
    ...
    private UmengUpdateListener updateListener = new UmengUpdateListener() {
        ...
        public void onUpdateReturned(int updateStatus, UpdateResponse updateInfo) {
            switch (updateStatus) {
            case 0: // has update
                UmengUpdateAgent.showUpdateDialog(HelpActivity.this, updateInfo);
                break;
            case 1: // has no update
                Toast.makeText(HelpActivity.this, "已是最新版", Toast.LENGTH_SHORT)
                        .show();
                break;
            case 2: // none wifi
                Toast.makeText(HelpActivity.this, "没有wifi连接， 只在wifi下更新", Toast.LENGTH_SHORT)
                        .show();
                break;
            case 3: // time out
